        ...
        <div className="relative z-20 flex flex-col justify-between p-16 w-full text-white">
          ...
          <div className="max-w-md">
            <h1 className="text-5xl font-extrabold leading-tight mb-6 animate-slide-up">
              Start your <span className="text-blue-200">investment</span> journey today.
            </h1>
            <p className="text-lg text-white/80 font-medium animate-slide-up" style={{ animationDelay: '0.2s' }}>
              Join thousands of investors using AI-driven analytics to build and manage their real estate portfolios with confidence.
            </p>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 lg:p-24 bg-white">
        ...
        <div className="w-full max-w-md animate-fade-in">
          ...
          <div className="mb-10">
            ...
            <p className="text-slate-500">Join Fore Site to start investing smarter.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="animate-slide-up" style={{ animationDelay: '0.5s' }}>
              <label className="flex items-start cursor-pointer group">
                <input className="w-5 h-5 rounded border border-slate-300 text-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-offset-0 bg-white accent-blue-600 transition-all cursor-pointer mt-0.5" type="checkbox" />
                <span className="ml-3 text-sm text-slate-600 group-hover:text-blue-600 transition-colors duration-200">
                  I agree to the <button className="text-blue-600 font-semibold hover:underline">Terms of Service</button> and <button className="text-blue-600 font-semibold hover:underline">Privacy Policy</button>
                </span>
              </label>
            </div>
            ...
            {/* Sign Up Button */}
            <button
              className="w-full bg-blue-600 hover:bg-blue-700 active:scale-95 text-white font-bold py-3.5 rounded-lg shadow-lg shadow-blue-600/30 transition-all duration-200 flex items-center justify-center gap-2 group animate-slide-up"
          ...
          {/* Divider */}
          <div className="relative my-10 animate-slide-up" style={{ animationDelay: '0.7s' }}>
          ...
          {/* Login Link */}
          <p className="mt-12 text-center text-sm text-slate-500 animate-slide-up" style={{ animationDelay: '0.9s' }}>
            Already have an account?
            <Link to={'/login'} className="text-blue-600 font-bold hover:text-blue-700 hover:underline ml-1 transition-all duration-200">
              Log in here
            </Link>
          </p>
        </div>
